...
chain.large <- mcmc(PDarray=PD.large, startPars=exp.large$par, type='exp', N=100000, burn=2000, thin=5, jumps =0.025)
chain.small <- mcmc(PDarray=PD.small, startPars=exp.small$par, type='exp', N=100000, burn=2000, thin=5, jumps =0.01)

...
plot(NULL,type='l',xlim=c(7000,3000),ylim=c(0,max(oxcal.large.plot$hi,na.rm=T)),xlab='CalBP',ylab='KDE',main='c')
...
plot(NULL,type='l',xlim=c(7000,3000),ylim=c(0,max(oxcal.small.plot$hi,na.rm=T)),xlab='CalBP',ylab='KDE',main='d')
...
plot(NULL,type='n',xlim=c(7000,3000),ylim=c(0,max(baydem.large.plot$hi,na.rm=T)),xlab='CalBP',ylab='Probability',main='e')
polygon(c(7000:3000,3000,7000),c(sim$PrDens,0,0),border=NA,col='lightgrey')
...
plot(NULL,type='n',xlim=c(7000,3000),ylim=c(0,max(baydem.small.plot$hi,na.rm=T)),xlab='CalBP',ylab='Probability',main='f')
polygon(c(7000:3000,3000,7000),c(sim$PrDens,0,0),border=NA,col='lightgrey')
